...
function Vector(x, y) {
	...
	/**
	 * Addiert zwei Vectoren miteinander und gibt den resultierenden Vector zurŸck
	 */ 
	this.add = function (v) {
	...
	/**
	 * Subrahiert einen Vector von einem anderen und gibt den resultierenden Vector zurŸck
	 */
	this.sub = function (v) {
		return new Vector(this.x - v.x, this.y - v.y);
	};
	...
	/**
	 * Multipliziert den Vector mit einem Faktor und gibt den resultierenden Vektor zurŸck
	 */
	...
	/**
	 * Dividiert den Vector durch einen factor und gibt den resultierenden Vektor zurŸck
	 */
	...
	/**
	 * Multipiziert diese Vector mit dem Ÿbergebenen Vector und gibt das Ergebnis zurŸck
	 */
	...
	/**
	 * Diese Funktion berechnet den Einheitsvektor und gibt diesen zurŸck
	 */
	...
	/**
	 * Berechnet die LŠnge des Vektors und gibt sie zurŸck
	 */
	...
	/**
	 * Gibt den Vector als String zurŸck
	 */
	this.toString = function () {
		return x+","+y;
	};
